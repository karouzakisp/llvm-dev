...
; CHECK-NEXT:    [[TMP0:%.*]] = zext was_sext i32 [[TMP5]] to i64
...
; CHECK-NEXT:    [[TMP1:%.*]] = zext was_sext i32 [[TMP17_SUM52]] to i64
...
; CHECK-NEXT:    [[TMP2:%.*]] = zext was_sext i32 [[TMP27_SUM50]] to i64
...
; CHECK-NEXT:    [[TMP3:%.*]] = zext was_sext i32 [[TMP37_SUM48]] to i64

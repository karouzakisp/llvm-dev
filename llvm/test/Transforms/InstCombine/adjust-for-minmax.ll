...
; CHECK-NEXT:    [[MAX:%.*]] = zext was_sext i32 [[TMP1]] to i64
...
; CHECK-NEXT:    [[MAX:%.*]] = zext was_sext <2 x i32> [[TMP1]] to <2 x i64>
...
; CHECK-NEXT:    [[MIN:%.*]] = zext was_sext i32 [[TMP1]] to i64
; CHECK-NEXT:    ret i64 [[MIN]]
;
  %a_ext = sext i32 %a to i64
...
; CHECK-NEXT:    [[MIN:%.*]] = zext was_sext <2 x i32> [[TMP1]] to <2 x i64>
; CHECK-NEXT:    ret <2 x i64> [[MIN]]
;
  %a_ext = sext <2 x i32> %a to <2 x i64>
